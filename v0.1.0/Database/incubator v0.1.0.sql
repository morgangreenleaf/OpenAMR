...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2018 at 01:00 PM
...
(8, 'Erythromycin', '15ug', 'E15', 21, 18, ''),
(9, 'Penicillin G', '1ug', 'PG1', 26, 26, ''),
(10, 'Gentamicin', '10ug', 'GM10', 17, 14, ''),
(11, 'Clindamycin', '2ug', 'CD2', 22, 19, ''),
(12, 'Fusidic Acid', '10ug', 'CF10', 24, 24, ''),
(13, 'Ceftriaxone', '30ug', 'CRO30', 19, 19, ''),
(14, 'Piperacillin(Tazobactam)', '75-10ug', 'PTZ85C', 0, 0, ''),
(15, 'Cefoxitin', '10ug', 'FOX10', 0, 0, ''),
(16, 'Ceftazidime', '30ug', 'CAZ30', 0, 0, '');
...
--
ALTER TABLE `petri_dish`
  MODIFY `petri_dishID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `samples`
  MODIFY `sample_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
